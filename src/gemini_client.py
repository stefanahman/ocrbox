...
class GeminiOCRClient:
    ...
    def __init__(self, api_key: str, model_name: str = "gemini-2.5-flash-lite", max_retries: int = 3, retry_delay: int = 2):
        """Initialize Gemini client.

        Args:
            api_key: Gemini API key
            model_name: Model to use (e.g., gemini-2.5-flash-lite, gemini-2.0-flash-exp)
